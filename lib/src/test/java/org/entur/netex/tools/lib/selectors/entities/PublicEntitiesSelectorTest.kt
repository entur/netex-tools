...
class PublicEntitiesSelectorTest {
    ...
    fun testSelectEntities() {
        ...
        val publicEntity = Entity(EntityId.Simple("1"), "Route", PublicationEnumeration.PUBLIC.value)
        val restrictedEntity = Entity(EntityId.Simple("2"), "Line", PublicationEnumeration.RESTRICTED.value)
