...
class FileIndexTest {
    ...
    fun testAddEntity() {
        ...
        val entity1 = Entity(id = EntityId.Simple("1"), type = "TestType", publication = "restricted")
        val entity2 = Entity(id = EntityId.Simple("2"), type = "TestType", publication = "restricted")
        val entity3 = Entity(id = EntityId.Simple("3"), type = "TestType", publication = "restricted")
        val entity4 = Entity(id = EntityId.Simple("4"), type = "TestAnotherType", publication = "restricted")
